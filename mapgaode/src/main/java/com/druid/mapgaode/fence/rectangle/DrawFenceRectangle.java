package com.druid.mapgaode.fence.rectangle;
...
public class DrawFenceRectangle extends FenceDrawRectangleLayer implements
        FenceDrawRectangleLayerApi<MapView, AMap> {
    ...
    protected List<LatLngBean> getFenceRectangle() {
        ...
        if(canDrawRectangleFence) {
            LatLng up_left_latlng = aMap.getProjection().fromScreenLocation(new Point(up_left));
            fencePoints.add(LatLngUtils.mapLatLngParse(up_left_latlng));
            LatLng up_right_latlng = aMap.getProjection().fromScreenLocation(new Point(up_right));
            fencePoints.add(LatLngUtils.mapLatLngParse(up_right_latlng));
            LatLng bottom_right_latlng = aMap.getProjection().fromScreenLocation(new Point(bottom_right));
            fencePoints.add(LatLngUtils.mapLatLngParse(bottom_right_latlng));
            LatLng bottom_left_latlng = aMap.getProjection().fromScreenLocation(new Point(bottom_left));
