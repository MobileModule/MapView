...
public class MapGoogleClusterLayer extends ClusterItemLayer<Marker> implements ClusterLayer<MapView, GoogleMap> {
    ...
    @Override
    public void bindMap(MapView mapview, GoogleMap map) {
